...
export const dessertCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "orman-meyve-cup", name: "Orman Meyve Cup", price: 300 },
      {
        ...
        price: 380,
        isNew: true,
        image: "/images/lotus-cup.jpg",
        description: "Lotus bisküvi ve karamel sos",
      },
      {
        id: "dubai-cup",
        name: "Dubai Cup",
        price: 400,
        isNew: true,
        image: "/images/dubai-cup.jpg",
        description: "Fıstıklı kadayıf ve çikolata",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "kucuk-paris-ekler-adet",
        name: "Küçük Paris Ekler (Adet)",
        price: 35,
      },
      {
        id: "kucuk-paris-ekler-porsiyon",
        name: "Küçük Paris Ekler (Porsiyon)",
        price: 200,
      },
      {
        id: "cikolatali-ekler-adet",
        name: "Çikolatalı Ekler (Adet)",
        price: 50,
      },
      {
        id: "cikolatali-ekler-porsiyon",
        name: "Çikolatalı Ekler (Porsiyon)",
        price: 250,
        isPopular: true,
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: "soguk-baklava-porsiyon",
        name: "Soğuk Baklava (Porsiyon)",
        price: 250,
        isPopular: true,
        image: "/images/soguk-baklava.jpg",
        description: "Kremalı soğuk baklava",
      },
      { id: "soguk-kadayif-kg", name: "Soğuk Kadayıf (Kg)", price: 900 },
      {
        id: "soguk-kadayif-porsiyon",
        name: "Soğuk Kadayıf (Porsiyon)",
        price: 250,
      },
    ],
  },
    ...
    items: [
      {
        ...
        price: 450,
        isNew: true,
        image: "/images/fistik-pasta.jpg",
        description: "Antep fıstıklı özel pasta",
      },
    ...
    items: [
      {
        ...
        priceSmall: 100,
        priceLarge: 120,
        sizeLabels: { small: "Küçük", large: "Büyük" },
      },
      {
        id: "americano",
        name: "Americano",
      ...
      },
      {
        ...
        description: "Yumuşacık süt köpüğü ile",
      },
      {
        id: "lotus-latte",
        name: "Lotus Latte",
        ...
        sizeLabels: { small: "Küçük", large: "Büyük" },
        isNew: true,
        image: "/images/lotus-latte.jpg",
        description: "Lotus bisküvi aroması",
      },
      {
        id: "cafe-mocha",
        name: "Cafe Mocha",
    ...
    items: [
      {
        ...
        sizeLabels: { small: "Küçük", large: "Büyük" },
        isPopular: true,
        image: "/images/sicak-cikolata.jpg",
        description: "Kremsi Belçika çikolatası",
      },
      {
        id: "beyaz-cikolata",
        name: "Beyaz Çikolata",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Serinletici buzlu latte",
      },
      {
        id: "ice-lotus-latte",
    ...
    items: [
      {
        ...
        priceSmall: 100,
        priceLarge: 140,
        sizeLabels: { small: "Küçük", large: "Double" },
        isPopular: true,
        image: "/images/turk-kahvesi.jpg",
        description: "Geleneksel közde pişirme",
      },
      {
        id: "menengic-kahvesi",
...
export const chefCombos: ComboItem[] = [
  ...
  },
  {
    ...
    items: ["Cafe Mocha (Büyük)", "Profiterol"],
    price: 390,
    originalPrice: 430,
    image: "/images/profiterol.jpg",
  },
